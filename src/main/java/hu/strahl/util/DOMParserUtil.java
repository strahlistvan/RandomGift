...
import hu.strahl.entity.Product;
...
public class DOMParserUtil {
    public static  void parseEbayItemXML(String urlString)  {
        ...
        try {
            ...
            Product product = new Product(productName, price, imgSrc, productLink, doc.title());
